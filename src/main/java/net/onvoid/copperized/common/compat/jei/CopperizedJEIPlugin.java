...
public class CopperizedJEIPlugin implements IModPlugin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        //registration.addRecipeCatalyst(new ItemStack(Items.RAW_COPPER), OxidationRecipeCategory.UID);
        //registration.addRecipeCatalyst() => , Ingredient.TagValue(ItemTags.createOptional(new ResourceLocation("forge", "tools/axes"))), AxeScrapingRecipeCategory.UID);
    }
}